...
public class DistributeCandies_1103 {
    private static int[] distributeCandies(int candies, int num_people) {
        ...
        int temp = 0;
        while (candies != 0) {
            result[temp % num_people] += Math.min(candies, temp + 1);
    ...
    public static void main(String[] args) {
        int candies1 = 7;
        int num_people1 = 4;
        int[] ints1 = distributeCandies(candies1, num_people1);
        System.out.println(Arrays.toString(ints1));

        int candies2 = 10;
        int num_people2 = 3;
        int[] ints2 = distributeCandies(candies2, num_people2);
